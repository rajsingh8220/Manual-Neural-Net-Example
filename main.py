...
def traverse_postorder(operation):
    """
    Tree PostOrder Traversal of nodes. Basically makes sure computations are done in the correct oder (Ax first, then Ax+b).
    """
    nodes_postorder = []
    def recurse(node):
...
z = add(y,b)
sess = Session()
mat_result = sess.run(operation=z, feed_dict={x:10})
print(mat_result)
